          ...
          <div className="col s12 m12 l12">
            ...
            <div className="row">
              <div className="col s12 m6 l6">
                ...
                <textarea name="ex7TrainerComments" className="materialize-textarea" defaultValue={this.props.workoutData.ex7TrainerComments} onChange={this.updateField} placeholder="Comments or concerns for your client"></textarea>
              </div>
              <div className="col s12 m6 l6">
