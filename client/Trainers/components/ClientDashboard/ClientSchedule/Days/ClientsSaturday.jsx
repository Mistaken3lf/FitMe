          ...
          <div className="row">
            <div className="col s12 m12 l12">
              ...
              <div className="col s12 m6 l6">
                ...
                <select className="browser-default" ref="saturdaysScheduleStart" name="saturdaysScheduleStart" value={this.props.scheduleData.saturdaysScheduleStart} onChange={this.updateField}>
                  <option value=""></option>
              ...
              <div className="col s12 m6 l6">
                ...
                <select className="browser-default" ref="saturdaysScheduleEnd" name="saturdaysScheduleEnd" value={this.props.scheduleData.saturdaysScheduleEnd} onChange={this.updateField}>
                  <option value=""></option>
                  <option value="12:00AM">12:00AM</option>
                  <option value="1:00AM">1:00AM</option>
                  <option value="2:00AM">2:00AM</option>
              ...
              <div className="row">
                <div className="col s12 m12 l12">
                  Description:
                  <input type="text" ref="saturdayDescription" name="saturdayDescription" placeholder="Workout Description" value={this.props.scheduleData.saturdayDescription} onChange={this.updateField} />
                </div>
              </div>
