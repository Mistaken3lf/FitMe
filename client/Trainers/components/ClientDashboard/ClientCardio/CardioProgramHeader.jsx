CardioProgramHeader = React.createClass({
  updateField(e) {
            ...
            <div className="col s12 m6 l9">
              <div className="row">
                <div className="col s12 m4 l3">
                  ...
                  <input type="number" name="cardioProgramAge" defaultValue={this.props.cardioData.cardioProgramAge} onChange={this.updateField} placeholder="Age" />
                </div>
              </div>
              <div className="row">
                <div className="col s12 m4 l3">
                  <span className="cardioLabel">Resting Heart Rate:</span>
                  <input type="number" name="cardioProgramRestingHeartRate" defaultValue={this.props.cardioData.cardioProgramRestingHeartRate} onChange={this.updateField} placeholder="Resting Heart Rate" />
                </div>
              </div>
              <div className="row">
