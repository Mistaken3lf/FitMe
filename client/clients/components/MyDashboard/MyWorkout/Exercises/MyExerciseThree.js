          ...
          <div className="col s12 m12 l12">
            ...
            <div className="row">
              <div className="col s12 m6 l6">
                ...
                <textarea name="ex3TrainerComments" className="materialize-textarea" defaultValue={this.props.workoutData.ex3TrainerComments} placeholder="Comments or concerns for your client" readOnly></textarea>
              </div>
              <div className="col s12 m6 l6">
