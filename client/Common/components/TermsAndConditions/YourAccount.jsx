    ...
    return (
      <div>
        ...
        <h6 className="extraPaddingTerms">
          ...
          disable any user identification code or password, whether
          ...
          these terms of use. If you know or suspect that anyone other than
          you knows your user identification code or password,
          you must promptly notify us at support@gofitme.
        </h6>
      </div>
    );
  }
