    ...
    <div className="container">
      <div className="row center">
        <div className="col s12 m6 offset-m3 l6 offset-l3 center">
          ...
          <span>
            <a href="/termsAndConditions" className="white-text">
              Terms And Conditions
            </a>
            |
            <a href="contactPage" className="white-text">Contact Us</a>
          </span>
        </div>
      </div>
      <div className="row">
        <div className="col s12 m6 offset-m3 l6 offset-l3">
          <p className="grey-text text-lighten-4 center-align">
            &lt;div&gt;elop provides the FitMe Web App as a service to the public and users
            of the application.
          </p>
        </div>
      </div>
